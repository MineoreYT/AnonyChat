...
function generateRandomName() {
  const adjectives = [
    "Swift","Silent","Brave","Lucky","Clever","Mighty",
    "Happy","Cosmic","Frosty","Shadow"
  ];
  const animals = [
...
export default function App() {
  ...
  const MessageBubble = ({ m }) => (
    <div
      style={{
        display: "flex",
        justifyContent: m.from === userID ? "flex-end" : "flex-start",
        marginBottom: 10
      }}
    >
      <div
        ...
        {selectedUser && (
          <div style={{ display: "flex", marginTop: 14 }}>
            <input
              ...
              onKeyDown={e =>
                e.key === "Enter" &&
                (selectedUser === "LIVE" ? sendLive() : sendPrivateMessage())
              }
              placeholder={
                selectedUser === "LIVE"
